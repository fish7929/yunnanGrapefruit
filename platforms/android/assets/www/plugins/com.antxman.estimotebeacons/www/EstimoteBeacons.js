cordova.define("com.antxman.estimotebeacons.EstimoteBeacons", function(require, exports, module) { var exec = require('cordova/exec');
...
EstimoteBeacons.prototype.notify = function(title, body, className, status, id, success) {
	//alert('inner notify');
	if(!isString(title)) {
	...
	cordova.exec(success, function(){}, 'EstimoteBeacons', 'notify', [title, body, className, status, id]);
	//alert('inner end');
};
